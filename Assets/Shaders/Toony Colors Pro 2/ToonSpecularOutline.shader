...
Shader "Toony Colors Pro 2/ToonSpecularOutline"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom noforwardadd interpolateview halfasview exclude_path:deferred exclude_path:prepass
		#pragma target 2.5
